...
//// no modo gen?rio de comunica??o indireta(bus 8 bits, RW, RD, Ao)////
/////////////////////////////////////////////////////////////////////////
//// ////
//// glcd_init(mode) ////
...
//// 19/12/2006 ////
//// ?lt.Altera??o 21/12/2006 ////
/////////////////////////////////////////////////////////////////////////
////
//// Defini??es antes da carga do driver:
////
////
...
//// #define GLCD_RST PIN_XX //Apenas definir se n?o tover resetado previamente(O driver faz o reset)
...
////
//// #define LARGE_LCD //O driver define automaticamente se linhas ou colunas>256pontos(Ex. 320x240p?xels)
////
/////////////////////////////////////////////////////////////////////////
#ifndef S1D13700
#define S1D13700
...
{
// Initialze some pins
#ifdef GLCD_RST //Sup?e-se que o dispositivo ja foi resetado
